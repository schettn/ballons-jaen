...
const Popup: FC<IPopupProps> = () => {
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      size={{ base: "sm", md: "3xl", lg: "4xl", xl: "6xl" }}
    >
      <ModalOverlay />
      <ModalContent>
        ...
        <ModalBody py="20">
          ...
          >
            ...
            <Stack flex="2" align={{ base: "center", md: "start" }}>
              ...
              >
                Wir sind momentan auf Betriebsurlaub, unser Büro ist deshalb
                nicht besetzt. Wir bearbeiten deine Anfragen und Bestellungen
                natürlich wieder wie gewohnt ab 06.08.2022.
              </Text>
              <Box>
                <Button
                  size={{ base: "sm", md: "md" }}
