    ...
    <>
      <Container maxW={CONTAINER_MAX_WIDTH}>
        <Flex
          ...
          pos="relative"
          h={{ base: '25rem', sm: '31.25rem', md: '43.75rem', lg: '62.5rem', xl: '75rem' }}>
          <Image
            pos="absolute"
            top="0"
            left={{ base: '-20%', md: '-40%' }}
          ...
          <Stack pos="relative" w="100%" top={{ base: '4rem', md: 'unset' }}>
            ...
            <Box>
              <Button size={{ base: 'xs', md: 'lg' }} mt={{ base: '8 !important', md: '4' }}>
                Beratungstermin
              </Button>
            </Box>
          </Stack>
          <Grid placeItems="center" pos="relative" top={{ base: '1.25rem', md: 'unset' }}>
            <Image
              borderRadius="full"
              boxShadow="light"
