  ...
  return (
    <Box
      ...
      <Container maxW={CONTAINER_MAX_WIDTH} pos="relative">
        ...
        <VStack>
          <Heading fontSize={{ base: 'md', md: '2xl', lg: '3xl', xl: '4xl' }} fontWeight="semibold">
            Steigen lassen von
            <Text ml="4" variant="cursive" size="80" as="span">
              Ballons
            </Text>
          </Heading>
          <Text fontSize={{ base: 'sm', lg: 'md' }} textAlign="center" maxW={{ md: '60%' }}>
            ...
            consectetur adipisicing elit. Recusandae ea praesentium, enim alias a nihil et aperiam
            <br /> <br />
            <Text
              as="span"
              ...
              cupiditate explicabo facere, eligendi molestias Lorem ipsum dolor sit amet consectetur
              adipisicing elit. Quidem, accusamus.
            </Text>
          </Text>
        </VStack>
      ...
      {/* for Mobile */}
      <Box h="25rem" pos="relative" overflow="hidden" display={{ base: 'block', md: 'none' }}>
        <Image pos="absolute" left="-6.25rem" w="12.5rem" src="/images/decorationen/ballons.png" />
        <Image
          pos="absolute"
          right="-6.25rem"
          w="14.375rem"
        ...
        <Box pos="absolute" maxW="full" bottom="3rem">
          <Image pos="absolute" left="0" src="/images/decorationen/left_transparent.svg" />
          <Image pos="absolute" right="0" src="/images/decorationen/right_transparent.svg" />
          <Flex overflowY="auto">
            {new Array(9).fill('').map((_, i) => (
