import { Container, Flex, Heading, Stack, HStack, Tag, Box, Text, Image } from '@chakra-ui/react';
    ...
    <Box
      ...
      <Container maxW={CONTAINER_MAX_WIDTH} as={Stack} gap={{ base: 4, lg: '8' }}>
        <Box pos="relative" top={{ base: '-40px', md: 0 }}>
          <Image src="/images/blog_page/hero_image.png" borderRadius="1.875rem" boxShadow="dark" />
          <Flex justify="space-between" mt="8" display={{ base: 'flex', md: 'none' }}>
            <HStack>
        ...
        <Stack pos="relative" top={{ base: '40px', md: 0 }} gap={{ base: 4, lg: '8' }}>
          <Flex justify="center">
